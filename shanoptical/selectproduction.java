 ...
 * @author MSI
 */
public class selectproduction extends javax.swing.JFrame {

    public selectproduction() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Select Production Details");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"2023/02/11", "Mr.sasna ranjan", "12", "Lenses", "70"},
                {"2023/02/11", "Mr.sasna ranjan", "14", "Plastic frame", "60"},
                {"2023/02/11", "Mr.sasna ranjan", "13", "Steel frame", "10"},
                {"2023/02/15", "Mr.sasna ranjan", "10", "rexin", "200"},
                {"2023/02/15", "Mr.sasna ranjan", "11", "Steel box", "110"},
                {"2023/02/15", "Mr.sasna ranjan", "14", "Plastic box", "75"},
                {"2023/02/21", "Mr.sasna ranjan", "09", "Glasses", "250"}
            },
            new String [] {
                "Date", "Supervisor", "Product Id", "Product name", "Qty"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            InputStream is = selectproduction.class.getResourceAsStream("/Resources/Gray.theme.json");
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new selectproduction().setVisible(true);
            }
        });
    }
