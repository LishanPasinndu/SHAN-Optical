 ...
 * @author MSI
 */
public class Searchad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Search Ad Details");
        ...
        jLabel7.setText("Ad type :-");

        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"School child offer", "Commercial", "120,000", "2023/01/10", "MR.Sarath daraniyagala"},
                {"Elder's Vision", "Commercial", "80,000", "2022/11/08", "Mr.kokila jayasooriya"},
                {"Introduce", "Artical", "15,000", "2021/04/15", "Mis.Harshi kokila"}
            },
            new String [] {
                "Ad Name ", "Type", "Budget", "Publish date", "Officer"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            InputStream is = Searchad.class.getResourceAsStream("/Resources/Gray.theme.json");
