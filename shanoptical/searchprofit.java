 ...
 * @author MSI
 */
public class searchprofit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Search profit or loss");
    ...
    public static void main(String args[]) {
        ...
        try {
            InputStream is = searchprofit.class.getResourceAsStream("/Resources/Gray.theme.json");
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchprofit().setVisible(true);
            }
        });
    }
